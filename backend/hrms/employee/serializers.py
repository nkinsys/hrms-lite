...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    department_info = DepartmentReadOnlySerializer(source='department', read_only=True)
    ...
    def to_representation(self, instance):
        ...
        rep['department'] = rep.pop('department_info')
        rep['attendance_status'] = getattr(instance, "attendance_status", None)
        return rep
