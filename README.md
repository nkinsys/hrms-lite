...
Login to Django admin and add departments.

Add employees using the frontend UI, mark attendance per employee per day, and access daily or MTD reports. Filter reports by department or date as needed.
...
Author
-------
Nishant Kumar - [GitHub Profile](https://github.com/nkinsys)
